...
<div class="wrapper" style="height: auto; min-height: 100%;">
                    ...
                    <div class="thumbnail">
                        <div class="caption">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="right" style="float: right;">
                                            <small>发布日期: <fmt:formatDate value="${food.tpFcreated}"
                                                                        pattern="yyyy-MM-dd:HH:mm:ss"/></small>
                                        </div>
                                        <strong style="color: #0b97c4">${food.tpFtitle}</strong>
                                        <div class="form-group">
                                            <img  style="height: 200px" src="${food.tpFpic}" />
                                        </div>
                                        <strong>美食名称: [${food.tpFname}]</strong><hr>
                                        <strong>美食价格: ${food.tpFprice}元/份</strong><hr>
                                        <strong>详细地址: ${food.tpAddress}</strong><hr>
                                        <strong>电话: ${food.tpPhone}</strong>
                                    </div>
                                </div>
                                <br>
                                ...
                                <hr>
                                <font color="#dc143c" size="10"><b>美食描述:</b></font>
                                ${food.tpFcontent}
                            </div>
                        </div>
                        <%--留言功能--%>
                        <div style="margin:0 2% 0 2%;">
                            ...
                            <form class="layui-form" action="/article/saveFoodWords" method="post">
                                ...
                                <input name="lw_food_id" value="${food.tpFid}" hidden="hidden"/>
                            ...
                            <div>
                                <ul>
                                    ...
                                    <c:forEach items="${lw_list}" var="words">
                                        <!-- 如果留言信息是在本文章下的才显示 -->
                                        <c:if test="${words.lw_food_id eq food.tpFid}">
                                            <li style="border-top: 1px dotted #01AAED">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="replycontainer layui-hide" style="margin-left: 61px;">
                                                        <form action="/article/saveFoodReply" method="post"
                                                              class="layui-form">
                                                            <input name="lr_food_id" id="lr_food_id"
                                                                   value="${food.tpFid}" hidden="hidden"/>
                                                ...
                                                <c:forEach items="${lr_list}" var="reply">
                                                    ...
                                                    <c:if test="${reply.lr_food_id eq food.tpFid&& reply.lr_for_words eq words.lw_id}">
    ...
    <script>
        ...
        $("#replyBtn").click(function () {
            ...
            $.ajax({
                url: '/article/saveFoodReply',
                type: 'POST',
                data: [{
                    lr_food_id: lr_food_id,
                    lr_name: lr_name,
                    lr_date: lr_date,
