...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-fw fa-cutlery"></i><span>美食管理</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="/admin/foodlist"><i class="fa fa-fw fa-cutlery"></i> 美食列表</a></li>
                    <li><a href="/admin/foodInsertForm"><i class="fa fa-fw fa-cutlery"></i>美食新增</a></li>
                </ul>
            </li>
