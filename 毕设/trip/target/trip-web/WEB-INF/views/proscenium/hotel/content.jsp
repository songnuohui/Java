					...
					<div class="thumbnail">
						<div class="caption">
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-md-12 col-lg-12">
										<div class="right" style="float: right;">
											<small>发布日期: <fmt:formatDate value="${hotel.created}"
																		pattern="yyyy-MM-dd HH:mm:ss"/></small>
										</div>
										<strong style="color: #0b97c4">${hotel.title}</strong><br><br>
										<div class="form-group">
											<img  style="height: 200px" src="${hotel.imgUrl}" />
										</div>
										<strong>房间类型：${hotel.houseType}&nbsp;</strong><hr/>
										<strong>可住人数：${hotel.peopleNum}</strong><hr>
										<strong>房间大小：${hotel.houseSize}</strong><hr>
										<strong>价格：${hotel.price}</strong><hr>
										<strong>详细地址: ${hotel.zip}</strong><hr/>
										<strong>联系电话: ${hotel.phone}</strong>
									</div>
								</div>
								...
								<br>
								<hr>
								<font color="#dc143c" size="10"><b>酒店描述:</b></font>
								${hotel.content}
						</div>
