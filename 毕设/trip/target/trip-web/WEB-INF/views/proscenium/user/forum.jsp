...
<head>
	...
	<style>
		.content-wrapper{
			background-image: url("/static/assets/img/test/bgimg1.png");
		}
	</style>
</head>
	...
	<div class="content-wrapper" style="min-height: 471px;">
		<div class="container">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<br>
					<li><a href="/user/info?uid=${user.uid}"><i class="fa fa-user"></i> 个人信息</a></li>
					<li><a href="#">SHOW</a></li>
				</ol>
			</section>
			<br>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="post-preview">
									...
									<p class="post-meta" style="margin: 10px 0; color: #0b93d5;">
										作者:${forum.tpAuthor} 发表于<%--tpIssueTime--%>
										<fmt:formatDate value="${forum.tpCreatTime}" pattern="yyyy-MM-dd:HH:mm:dd"/>
									</p>
									<div class="tags">
											${forum.tpTag}
									</div>
