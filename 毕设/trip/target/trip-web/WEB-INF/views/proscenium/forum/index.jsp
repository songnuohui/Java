	...
	<div class="content-wrapper" style="min-height: 471px">
		<div class="container">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<br>
					<li><a href="/forum/index"><i class="fa fa-dashboard"></i>论坛列表</a></li>
					<li><a href="#">FORUM</a></li>
					<div class="box-tools">
						<form action="/forum/forumPointSearch" method="get">
							<div class="input-group input-group-sm" style="width: 150px; padding-top: 5px;">
							...
							<div class="caption">
								<div class="container-fluid">
									<div class="row">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="post-preview">
													...
													<p class="post-meta" style="margin: 10px 0; color: #0b93d5;">
														作者:${forum.tpAuthor} Created By
														<fmt:formatDate value="${forum.tpCreatTime}" pattern="yyyy-MM-dd"/>
													</p>
													<div class="tags">
															${forum.tpTag}
													</div>
										...
										<ul class="pager">
											<li class="next">
												<a href="/forum/index<%--/archives/2/--%>">下一页 →</a>
											</li>
										</ul>
									</div>
