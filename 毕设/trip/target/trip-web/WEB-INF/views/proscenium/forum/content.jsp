								...
								<div class="row">
									...
									<div class="col-md-12 col-lg-12">
										<div class="right" style="float: right;">
											发布日期: <fmt:formatDate value="${forum.tpCreatTime}"
											                            pattern="yyyy-MM-dd:HH:mm:ss"/>
										</div>
										<h2><b>帖子标题：&nbsp;</b></h2></br><h3>${forum.tpTitle}</h3></br>
										<h2><b>副标题：&nbsp;</b></h2></br><h4 class="post-subtitle" style="font-style: italic">
											${forum.tpSubTitle}
										</h4>
										<br>
										...
										<br>
										<hr>
										<strong style="color: red">发布内容：</strong>
										${forum.tpTcontent}
									</div>
								</div>
								<hr>
