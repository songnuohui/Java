							...
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-md-12 col-lg-12">
										...
										<strong style="color: #0b97c4">${viewPoint.tpTitle}</strong><br><br>
										<div class="form-group">
										<img  style="height: 200px" src="${viewPoint.tpVpic}" />
									</div>

										<strong>[${viewPoint.tpVname}&nbsp;<small>| ${viewPoint.tpLocation}</small>]</strong><br/><hr>

										<strong>等级: ${viewPoint.tpLevel}</strong><br/><hr>
										<strong>开放时间: ${viewPoint.tpOpentime}</strong><br/><hr>
										<strong>景点价格: ${viewPoint.tpPrice}元/人</strong><br/><hr>
										<strong>类型: ${viewPoint.tpVtype}</strong><br><hr>
										<strong>详细地址: ${viewPoint.tpZip}</strong><br/><hr>
										<strong>联系电话: ${viewPoint.tpVphone}</strong>
								...
								<hr>
								<font color="#dc143c" size="10"><b>景点描述:</b></font>
