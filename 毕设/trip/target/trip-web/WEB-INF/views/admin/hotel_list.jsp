					...
					<div class="box-tools">
						<form action="/admin/hotelPointSearch" method="get">
							<div class="input-group input-group-sm" style="width: 200px;">
								<input type="text"  name="keyword" class="form-control pull-right" placeholder="按城市，房型，床型搜索">
					...
					<table id="myuserstable" class="table table-bordered table-striped">
						...
						<c:forEach items="${hotels}" var="hotel">
							<tr>
								...
								<td>${fn:substring(hotel.phone,0 ,5 )}...</td>
								<td><span class="label label-primary">${hotel.peopleNum}</span></td>
								<td>${fn:substring(hotel.zip,0,5)}...</td>
								...
								<td><fmt:formatDate value="${hotel.created}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
								<td>
