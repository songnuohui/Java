					...
					<div class="box-tools">
						<form action="/admin/viewPointSearch" method="get">
							<div class="input-group input-group-sm" style="width: 200px;">
								<input type="text" name="keyword" class="form-control pull-right" placeholder="按名称，类型，归属地搜索">
					...
					<table id="myuserstable" class="table table-bordered table-striped">
						...
						<c:forEach items="${viewPoints}" var="viewPoint">
							<tr>
								...
								<td><fmt:formatDate value="${viewPoint.tpCreattime}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
								<td>
